...
public interface EmployeesOperationsApi {
	String ADD = "add";
	String GET_EMPLOYEE = "getEmployee";
	String REMOVE_EMPLOYEE ="removeEmployee";
	String GET_EMPLOYEES_SALARY = "getEmployeeSalary";
	String GET_COMPANIES_AVG_SALARY = "getCompaniesAvgSalary";
	String GET_EMPLOYEE_GROUP_BY_SALARY = "getEmployeeGroupBySalary";
